      ...
      <Element name="location" className="location-container">
        ...
        <Element name="rsvp" className="location-wrapper">
          ...
          <div className="location-details">
            ...
            <p>The ceremony will be held on Saturday, <strong>June 17, 2017</strong> at <br /><br /><strong>Yorba Linda Mansion - 4490 Ohio Street, Yorba Linda, CA 92886, United States</strong><br /><br /> It will start at <strong>Twelve O'Clock</strong> in the afternoon.</p>
            <p>A celebration with food and dancing will follow at the venue. Please RSVP with First and Last name by June 12. Click RSVP below if you plan on attending</p>
            <p>We <strong>Highly Recommend</strong> that people try to use <strong>UBER/LYFT</strong> or <strong>Carpool</strong> as it may be hard to find a parking spot.</p>
            ...
            <div className="location-rsvp" style={{ display: 'flex !important', justifyContent: 'space-between', width: '100%' }}>
